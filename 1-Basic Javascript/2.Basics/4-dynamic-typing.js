...
-> In static typed Language , when we declare a variable the type of the variable is set and it cannot be changed in the future.
-> In dynamic typed Language, the type of a variable can change in run time.
*/ 
